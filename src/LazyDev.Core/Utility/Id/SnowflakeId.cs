...
namespace LazyDev.Core.Utility.Id
{
    public class SnowflakeId
    {
        ...
        public SnowflakeId(int datacenterId, int workerId)
        {
            ...
            {
                throw new System.Exception($"datacenter Id can't be greater than {MaxDatacenterId} or less than 0");
            }
            if (workerId > MaxWorkerId || workerId < 0)
            {
                throw new System.Exception($"worker Id can't be greater than {MaxWorkerId} or less than 0");
            }
            WorkerId = workerId;
